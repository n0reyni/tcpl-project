...
export default function Medecine({ name, description, image, prix, redirectUrl }) {
            ...
            <div className="relative my-5">
                ...
                <div className="absolute bottom-0 left-0 w-full px-5 py-4 bg-white bg-opacity-50 dark:bg-opacity-80 mx-5 ">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <a href={redirectUrl} target="__blank" className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Acheter</a>
